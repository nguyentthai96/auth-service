# Brainstorm Notes: FR-010-menu-permission

> Deep thinking notes cho Menu Permission Management — phân tích hướng thiết kế, trade-offs, và quyết định kiến trúc.
...
1. MenuEntity (Entity)
2. MenuPermissionEntity (Entity)
3. MenuRepository (Repository)
4. MenuPermissionRepository (Repository)
5. MenuPermissionService (Service)
6. MenuPermissionCacheService (Service)
7. MenuController (Controller)
8. MenuPermissionController (Controller)
9. PermissionAuthorizationFilter (Filter)
