...
- [x] **Task 3: Write Cache Encryption Correctness Test**
...
- [x] **Task 4: Write K6 Auth Flow (Login)**
...
- [x] **Task 5: Write K6 Profile Flow (Get Me)**
  - File: `auth-service/tests/load/profile_flow.js` | Action: [NEW]
  - Base: K6 script
  - FR: FR-003, FR-006
- [x] **Task 6: Configure K6 Gradle Exec Task**
