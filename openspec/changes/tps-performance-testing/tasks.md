...
- [x] **Task 1: Add datasource-proxy dependency to base-testing-starter**
...
- [x] **Task 2: Create DataSourceProxyConfig**
...
- [x] **Task 3: Create QueryCountAssertions DSL**
...
- [x] **Task 4: Create @AssertQueryCount annotation**
...
- [x] **Task 5: Create AssertQueryCountExtension**
...
- [x] **Task 6: Add WireMock + datasource-proxy dependencies to auth-service**
...
- [x] **Task 7: Create WireMockExternalServiceTest**
...
- [x] **Task 8: Enhance CacheEncryptionIntegrationTest**
...
- [x] **Task 9: Create QueryCountIntegrationTest**
...
- [x] **Task 10: Create helpers.js shared utility**
...
- [x] **Task 11: Expand auth_flow.js to multi-scenario**
...
- [x] **Task 12: Expand profile_flow.js**
...
- [x] **Task 13: Create cache_benchmark.js**
...
- [x] **Task 14: Add k6CacheBenchmark Gradle task**
  - File: `auth-service/build.gradle.kts` | Action: [MODIFY]
...
- [x] **Task 15: Add JMH plugin and configuration**
  - File: `auth-service/build.gradle.kts` | Action: [MODIFY]
...
- [x] **Task 16: Create EncryptionBenchmark**
...
- [x] **Task 17: Create SerializationBenchmark**
