...
export default function () {
  ...
  // Step 1: List users
  const usersRes = http.get(`${BASE_URL}/api/v1/users?page=0&size=10`,
  ...
  const assignRes = http.post(`${BASE_URL}/api/v1/roles/1/users`,
  ...
  const verifyRes = http.get(`${BASE_URL}/api/v1/users/1/roles`,
