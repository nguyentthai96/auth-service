...
export default function () {
  ...
  const ssoRes = http.get(`${BASE_URL}/api/v1/auth/sso/login?provider=google`,
  ...
  const callbackRes = http.get(`${BASE_URL}/api/v1/auth/sso/callback?code=mock_code&state=mock_state`,
