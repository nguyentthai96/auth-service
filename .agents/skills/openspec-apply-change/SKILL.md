...
4.5. **Load and Validate Project Standards (MANDATORY — before any code generation)**
...
6. **Implement tasks (loop until done or blocked)**
   ...
   - **Strictly comply** with all standards and rules loaded in Step 4.5
...
7. **Generate Extended Tracking Artifacts** (Auto — after ALL tasks complete)

   Generate/update in `openspec/changes/<name>/`:

   | Artifact | When to Create | Content |
   |----------|---------------|---------|
   | `todo-uncover.md` | If any `TODO`, `FIXME`, or uncovered edge cases found | Unresolved items list |
...
- **NEVER generate code without first loading and validating all 4 core standard documents** (Step 4.5)
