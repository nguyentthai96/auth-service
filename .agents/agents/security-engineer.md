...
- AES/RSA encryption for sensitive data (PIN, OTP)
- Data integrity checking (checksum, HMAC)
- Key rotation and lifecycle management
- TLS/mTLS configuration and certificate pinning
- Cipher suite selection and hardening
- Secure random generation for tokens and OTP
- End-to-end encryption (E2EE) patterns
...
Integration with other agents (optional — invoke when agent exists):
...
> **Note:** Not all agents listed above are currently available. If an agent does not exist, handle the security concern directly or flag for manual review.
