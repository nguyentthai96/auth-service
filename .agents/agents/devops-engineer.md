...
> **Supporting**:
> - `skills/mermaid-diagram-enterprise/` — Deployment architecture & CI/CD pipeline diagrams
> - `skills/software-architecture/` — C4 Model, deployment architecture templates
