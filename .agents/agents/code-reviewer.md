...
> - `skills/mermaid-diagram-enterprise/` — Visualize complex flows during review
...
- Work with `spring-boot-engineer` on Spring-specific patterns
- Support `devops-engineer` on deployment configuration review